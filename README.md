atom: Assortment of technologies including Arquillian
========================
Author: currying
Level: Intermediate
...
Source: <https://github.com/currying/atom/>
...
There is a tutorial for this quickstart in the [Getting Started Developing Applications Guide](https://github.com/currying/atom/).
...
4. This will deploy `target/atom.war` to the running instance of the server.
 

Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/atom/>.
